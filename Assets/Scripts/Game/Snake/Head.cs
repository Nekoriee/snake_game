    ...
    public override void UpdateSprite(SnakeState state)
    {
        switch (state)
        {
            case SnakeState.normal:
                gameObject.SetTextureOffset(new Vector2(0, 0.8f));
                break;
            case SnakeState.burn:
                gameObject.SetTextureOffset(new Vector2(0.4f, 0.8f));
                break;
            case SnakeState.freeze:
                gameObject.SetTextureOffset(new Vector2(0.2f, 0.8f));
                break;
            case SnakeState.gold:
                gameObject.SetTextureOffset(new Vector2(0.6f, 0.8f));
                break;
